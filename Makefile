...
537pfsim-fifo: sim-fifo.o pt/pagetable.o algo/clock.o algo/fifo.o algo/lru.o 
	gcc -o 537pfsim-fifo sim-fifo.o pt/pagetable.o algo/clock.o algo/fifo.o algo/lru.o 

537pfsim-lru: sim-lru.o pt/pagetable.o algo/clock.o algo/fifo.o algo/lru.o 
	gcc -o 537pfsim-lru sim-lru.o pt/pagetable.o algo/clock.o algo/fifo.o algo/lru.o 

537pfsim-clock: sim-clock.o pt/pagetable.o  algo/clock.o algo/fifo.o algo/lru.o 
	gcc -o 537pfsim-clock sim-clock.o pt/pagetable.o algo/clock.o algo/fifo.o algo/lru.o 
